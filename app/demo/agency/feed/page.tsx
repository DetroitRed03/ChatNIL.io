...
import { CampaignFeed } from '@/components/demo/browse/CampaignFeed';
...
import { Target, Users, DollarSign, MapPin, List } from 'lucide-react';
...
export default function AgencyFeedDemoPage() {
        ...
        <div className="flex items-start justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-text-secondary">
              Scroll through campaigns and select one to view matched athletes
            </p>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={() => router.push('/demo/agency/grid')}
              className="px-4 py-2 text-sm border border-border rounded-lg hover:bg-background-hover transition-colors"
            >
              Grid
            </button>
