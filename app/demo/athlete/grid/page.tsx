...
import { AthleteBrowser } from '@/components/demo/browse/AthleteBrowser';
...
import { Target, TrendingUp, Grid3x3 } from 'lucide-react';
...
export default function AthleteGridDemoPage() {
        ...
        <div className="flex items-start justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-text-secondary">
              Browse athletes in a card grid and select one to view their Fair Market Value
            </p>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={() => router.push('/demo/athlete/feed')}
              className="px-4 py-2 text-sm border border-border rounded-lg hover:bg-background-hover transition-colors"
            >
              Feed
            </button>
