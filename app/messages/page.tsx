...
/**
 * Messages Page - PAUSED FEATURE
 *
 * The messaging feature is temporarily paused while we focus on
 * compliance-first features. This page shows a "Coming Soon" message
 * and redirects users to their dashboard.
 *
 * To re-enable:
 * 1. Restore the original MessagesPage component from git history
 * 2. Re-enable the Messages link in HeaderUserMenu and HeaderMobileMenu
 * 3. Re-enable the Messages keyboard shortcut in NavigationShell
 */
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50 flex items-center justify-center p-6">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-gray-600 mb-8 leading-relaxed">
          We're building something special for athlete-brand connections.
          For now, focus on learning about NIL compliance and validating your deals.
        </p>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-8 text-left">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="flex items-start gap-2">
              ...
              Direct messaging with verified brands
            </li>
            <li className="flex items-start gap-2">
              <span className="text-orange-500 mt-0.5">•</span>
            ...
            <li className="flex items-start gap-2">
              <span className="text-orange-500 mt-0.5">•</span>
              Compliance-checked conversations
            </li>
          </ul>
        </div>
