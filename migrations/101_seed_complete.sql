-- ============================================================================
-- Migration 101: Complete Agency Dashboard Seeding
-- ============================================================================
-- Creates agency profile for existing auth user, then seeds test data
...
DECLARE
  ...
  v_athlete_ids UUID[];
BEGIN
  -- Step 1: Create agency profile for existing auth user
  ...
  RAISE NOTICE 'Created agency profile for agency-test@chatnil.io';
  ...
  RAISE NOTICE '✅ Complete! Test data seeded successfully.';
