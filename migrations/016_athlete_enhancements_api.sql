-- ============================================================================
-- Migration 016: Athlete Profile Enhancements (API-Compatible Version)
-- ============================================================================
-- Note: Transaction wrappers removed for REST API compatibility
-- ============================================================================
...
CREATE TRIGGER trigger_update_calculated_fields
  BEFORE INSERT OR UPDATE OF
    ...
    nil_preferences, full_name, email, profile_photo_url, school_name,
