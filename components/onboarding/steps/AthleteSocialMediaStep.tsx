...
export default function AthleteSocialMediaStep({
  ...
  // Debug logging
  console.log('🔍 Social Media Form Debug:', {
    isValid,
    skipForNow,
    socialStatsCount: socialStats?.length || 0,
    errors: errors,
    buttonEnabled: isValid || skipForNow
  });
  ...
  const onSubmit = (data: AthleteSocialMediaData) => {
            ...
            return (
              <div key={field.id} className="bg-white border-2 border-gray-200 rounded-xl p-5 hover:border-blue-300 transition-colors">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <Controller
                      name={`social_media_stats.${index}.followers`}
                      control={control}
                      defaultValue={0}
                      render={({ field }) => (
                        <NumberStepper
                  ...
                  <div>
                    <Controller
                      name={`social_media_stats.${index}.engagement_rate`}
                      control={control}
                      defaultValue={0}
                      render={({ field }) => (
                        <NumberStepper
