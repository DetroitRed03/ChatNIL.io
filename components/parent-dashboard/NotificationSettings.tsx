...
interface NotificationSettingsProps {
  ...
  onSave: (preferences: NotificationPrefs) => Promise<void>;
}

export function NotificationSettings({ preferences: initialPreferences, onSave }: NotificationSettingsProps) {
  const [preferences, setPreferences] = useState<NotificationPrefs>(initialPreferences);
  ...
  const options = [
    ...
    {
      key: 'chapterCompletion' as const,
